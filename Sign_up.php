...
<head>
    ...
    <script>
        function myfunction() {
            var v1 = document.forms["myforms"]["password"];
            var v2 = document.forms["myforms"]["pass"];
            if (v1 !== v2)
...
<nav class="navbar navbar-inverse navbar-static-top" style="font-size: 20px; margin:0px">
    ...
    <div class="collapse navbar-collapse mynavbar" >
        ...
        <div class="nav navbar-nav navbar-right" style="margin-right: 20px">
            <li><a href="login.php" style="font-size: 15px"><span class="glyphicon glyphicon-user"></span> login</a></li>
            <li class="active" style="font-size: 15px"><a href="Sign_up.php">signup</a></li>
        </div>
    </div>
</nav>
...
<!--sign up-->
<div class="container">
    <form name='myform' method="post" action="register_signup.php" class="container ig1" style=" width: 600px; height: 650px; background-color: #28a745; border-radius: 15px; margin-top: 25px; padding:0px">
        <div class="container-fluid" style="background-color: green; border-radius: 15px; margin-bottom:20px">
            <h1 style="font-size: 50px; text-align: center">Sign up</h1></div>
        <label style="margin-left: 50px"><b style="font-size: 20px">Username</b></label><br>
        <center><input type="text" name="username" placeholder="username" required style="width: 500px; height: 35px; font-size: 18px; border-radius: 8px; padding: 7px"><br></center><br>
        <label style="margin-left: 50px"><b style="font-size: 20px">Email id</b></label><br>
        <center><input type="email" name="email" placeholder="email" required style="width: 500px; height: 35px; font-size: 18px; border-radius: 8px; padding: 7px"><br></center><br>
        <label style="margin-left: 50px"><b style="font-size: 20px">Password</b></label><br>
        <center><input type="password" name="password" placeholder="password" required style="width: 500px; height: 35px; font-size: 18px; border-radius: 8px; padding: 7px"><br></center><br>
        <label style="margin-left: 50px"><b style="font-size: 20px">Confirm Password</b></label><br>
        <center><input type="password" name="pass" placeholder="confirm password" required style="width: 500px; height: 35px; font-size: 18px; border-radius: 8px; padding: 7px"><br></center><br>
        <center><button type="submit" onclick="myfunction()" style="width: 200px; height: 40px; font-size: 18px; border-radius: 10px;">Signup</button><br><br>
        <p>Or sign up with</p></center>
        <div class="row">
                <div class="col-md-6">
                    <?php
            ...
            <div class="col-md-6"><a href="#"><button type="button" class="btn"  style="width: 200px; height: 50px; margin-left: 10px; margin-bottom: 20px; border-radius: 5px">Facebook</button></a></div>
        </div>
        <center><p>Already a member? <a href="login.php"> Login now</a></p></center>
    </form>
</div>
